...
import com.runanywhere.runanywhereai.ui.navigation.VoiceTest
...
fun AppTopBar(
    ...
    when {
        ...
        destination.hasRoute<VoiceTest>() -> StandardTopBar("Test por voz", showMenu, onMenu, canNavigateBack, onNavigateBack)
